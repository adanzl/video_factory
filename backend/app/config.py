...
class Config:
    ...
    max_title_length: int = int(os.getenv("MAX_TITLE_LENGTH", "24"))  # 脚本标题与封面折行上限
    ...
    agnes_video_download_timeout_sec: float = float(
    ...
    agnes_video_task_max_retries: int = int(os.getenv("AGNES_VIDEO_TASK_MAX_RETRIES", "2"))
