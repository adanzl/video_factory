...
def build_topic_system_prompt(*, max_title_len: int) -> str:
    return (
        ...
        "如果 track=历史悬案，title 格式：事件代号：反常画面。例如：烛影斧声：宋太祖半夜暴毙。雍正暴毙：圆明园咯血无人敢近。title 16 字以内。"
        ...
        "注意：科技产业链、芯片、光刻胶、手机、电子产品等话题绝对不要选「历史悬案」，应选「数码小白避坑」或「日常科学原理」。"
        "只有涉及历史人物死亡、失踪、宝藏、未解之谜的才选「历史悬案」。\n"
