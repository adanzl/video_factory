...
_IMAGE_PROMPT_RULE_DAILY_STORY = (
    ...
    + "【参考图说明】角色参考图为昭昭（左）与灿灿（右）并排图，image_prompt须分别写清各角色外貌特征，帮助模型区分。妈妈角色无参考图，出图须在image_prompt中明确写清其外貌特征（成年女性，黑色长发，米色上衣牛仔裤）。"
    ...
    + "例子：'将参考图中的人物形象完全置于全新的客厅场景中，保留昭昭的男孩气黑色超短发（发长在耳垂以上、清晰露出双耳及整个后颈、齐耳学生头）圆脸蓝色短袖T恤和灿灿的黑色马尾辫粉色卫衣，比姐姐矮一点，彻底改变原始构图和背景。新场景中昭昭和灿灿跪坐争夺拼图盒，昭昭瞪大眼睛张大嘴巴、灿灿眯眼笑伸手去抢，妈妈穿着米色上衣牛仔裤站在门口无奈摇头，儿童情绪涂鸦风格，彩铅与蜡笔混合笔触，左侧自然光，低角度仰视构图。'"
)
