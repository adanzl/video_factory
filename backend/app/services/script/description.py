    ...
    *,
    ...
    if content_style == CONTENT_STYLE_DAILY_STORY:
        return (
            ...
            "第二行点出本集姐弟/亲子笑点。"
            "勿写长列表、勿堆砌点赞收藏等互动话术；勿在简介末尾加 # 话题标签（标签单独填写）；"
            "口语自然，事实与口播一致，不得编造。"
            "禁止：医疗养生承诺、理财荐股、时政情感、虚假夸张标题党、外链与联系方式；"
            "禁止套用科普话术（如「一分钟讲清原理」）。"
            'JSON 输出样例：{"video_description": "钩子句。本集笑点。"}'
        )
    return (
        ...
        "第二行点出本集核心收获。"
        "勿写长列表、勿堆砌点赞收藏等互动话术；勿在简介末尾加 # 话题标签；"
        "口语自然，事实与口播一致，不得编造口播未涉及的内容。"
        "禁止：医疗养生承诺、理财荐股、时政情感、虚假夸张标题党、外链与联系方式。"
        'JSON 输出样例：{"video_description": "钩子句。核心收获。"}'
    )
