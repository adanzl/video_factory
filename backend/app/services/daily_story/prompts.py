...
【项目背景】
- 动画形式：儿童绘本插画风格，平涂上色，柔和明亮的色彩，轻微水彩纸纹理，简洁圆润线条
...
【图生图提示词生成规则】
每条提示词必须包含以下三部分，顺序固定：
1. 风格前缀（固定）："儿童情绪涂鸦风格，彩铅和蜡笔混合笔触，用力不均的线条，主观夸张变形，高饱和色彩，涂色出界，横格笔记本纸背景，橡皮擦拭痕迹，手工感，孩子气的构图。"
2. 场景+角色描述：明确写出昭昭和灿灿的外貌特征+当前动作+背景环境
3. 镜头术语：说明景别（全景/中景/特写）
