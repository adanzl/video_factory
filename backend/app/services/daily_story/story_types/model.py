...
STORY_TYPE_KEYWORDS: dict[str, frozenset[str]] = {
    ...
    "N": frozenset(
        {
            "正经胡说", "一本正经", "胡说", "荒诞", "无厘头", "哭笑不得",
            "愣住", "因为", "所以", "童言", "歪理", "跳跃逻辑", "接不住",
        },
    ),
    "O": frozenset(
        {
            "目标错位", "光顾着赢", "顾着赢", "猜拳", "剪刀石头布",
            "赢了没", "菜没了", "只剩", "抢吃", "吹蜡烛", "白赢",
        },
    ),
    "P": frozenset(
        {
            "整蛊", "互整", "挑战", "尝尝", "加料", "回敬", "认输",
            "不了不了", "再试试", "轮到你", "硬撑",
        },
    ),
    "Q": frozenset(
        {
            "耍赖", "重抽", "逞强", "借口", "看穿", "拆穿", "翻车",
            "推给", "胃小", "心思", "洗碗", "露馅",
        },
    ),
}
