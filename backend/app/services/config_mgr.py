...
CONFIG_GROUPS: tuple[ConfigGroupDef, ...] = (
    ...
    ConfigGroupDef(
        ...
        items=(
            ...
            _f("clip_fps", "CLIP_FPS", "分镜 clip 帧率", "number", min_value=12, max_value=60),
            _f(
                "segment_xfade_duration_sec",
                "SEGMENT_XFADE_DURATION_SEC",
                "分镜转场时长 (秒)",
                "number",
                min_value=0.05,
            ...
            _f(
                "segment_xfade_transition",
                "SEGMENT_XFADE_TRANSITION",
                "分镜转场类型",
                "select",
                options=("none", "fade", "dissolve", "wipeleft", "wiperight", "slideleft", "slideright"),
            ),
    ...
    ConfigGroupDef(
        ...
        items=(
            ...
            _f(
                ...
                min_value=1,
                max_value=9999,
                description="chat 旧 tid 占位，默认 201；勿用 164（健身）",
            ),
            _f(
                "bili_human_type2_chat",
                "BILI_HUMAN_TYPE2_CHAT",
                "chat 新分区 ID",
                "number",
                min_value=1,
                max_value=9999,
                description="chat human_type2，默认 1025 亲子",
            ),
            _f(
                "bili_activity_tag",
                "BILI_ACTIVITY_TAG",
