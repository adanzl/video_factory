"""测试 need_opening=True，保存提示词+输出到文件"""
...
OUTPUT = Path(__file__).resolve().parent / "test_opening_output.txt"

TIMELINE = {
  "title": "美国建国250周年无人机庆典", "duration_sec": 189.0,
  "scenes": [
...
prompts = build_material_script_prompts(
    "美国建国250周年庆典无人机表演",
    video_timeline=TL_JSON, max_title_length=16,
    narration_target_words=785, chars_per_sec=cps, need_opening=True,
)
